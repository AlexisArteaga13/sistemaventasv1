        ...
        <div class="box">
          ...
          <div class="panel-body" style="height: 500px;" id="formularioregistros">
            ...
            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                ...
                <select id="idcaja" name="idcaja" class="form-control selectpicker" data-live-search="true"
                  required>
              ...
              <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <label>Serie:</label>
                <input readonly type="text" class="form-control" name="serie_comprobante" id="serie_comprobante" maxlength="7"
                  placeholder="Serie">
              </div>
              <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <label>Número:</label>
                <input type="text" class="form-control" readonly name="num_comprobante" id="num_comprobante" maxlength="10"
