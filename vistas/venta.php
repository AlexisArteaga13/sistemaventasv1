    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="panel-body" style="height: 470px;" id="formularioregistros">
            <form name="formulario" id="formulario" method="POST">
              <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <label>Caja(*):</label>

                <select id="idcaja" name="idcaja" class="form-control selectpicker" data-live-search="true" required>
              ...
              <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <label>Fecha(*):</label>
                <input type="date" readonly class="form-control" name="fecha_hora" id="fecha_hora" required="">
              </div>
              ...
              <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <label>Serie:</label>
                <input type="text" readonly class="form-control" name="serie_comprobante" id="serie_comprobante" maxlength="7"
                  placeholder="Serie">
              </div>
              <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <label>Número:</label>
                <input type="text" readonly class="form-control" name="num_comprobante" id="num_comprobante" maxlength="10"
...
<!-- Modal -->
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" styke="width: 90%">
