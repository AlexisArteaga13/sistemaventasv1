...
$("#idcategoria").change(function(event){
    ...
    $.post("../ajax/articulo.php?op=mostrarselect",{idcategoria : idcategoria}, function(r){
		console.log(r);
...
function mostrar(idarticulo)
{
	...
	$.post("../ajax/articulo.php?op=mostrar",{idarticulo : idarticulo}, function(data, status)
	{
		...
		mostrarform(true);
		//console.log(data);
		$.post("../ajax/subcategoria.php?op=mostrarcate",{idSubcategoria : data.id_subcategoria}, function(datos){
			datos = JSON.parse(datos);	
			///console.log(datos);
			$("#idcategoria").val(datos.idcategoria);
			$('#idcategoria').selectpicker('refresh');
			// MOSTRAR SELECT DEL EDITAR
			$.post("../ajax/articulo.php?op=mostrarselect",{idcategoria : datos.idcategoria}, function(r){
			//console.log(r);
			$("#idsubcategoria").html(r);
			$("#idsubcategoria").val(data.id_subcategoria);
			$('#idsubcategoria').selectpicker('refresh');
