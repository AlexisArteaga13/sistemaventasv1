...
{
	$.post("../ajax/cargos.php?op=mostrar",{idcargo : idcargo}, function(data, status)
	{
...
function desactivar(idcargo)
{
	bootbox.confirm("¿Está Seguro de desactivar el cargo?", function(result){
		if(result)
        {
        	$.post("../ajax/cargos.php?op=desactivar", {idcargo : idcargo}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
...
function activar(idcargo)
{
	bootbox.confirm("¿Está Seguro de activar el cargo?", function(result){
		if(result)
        {
        	$.post("../ajax/cargos.php?op=activar", {idcargo : idcargo}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
