                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select id="impuesto" name="impuesto" class="form-control selectpicker" data-live-search="true" required>
                              <option value="1" >Tiene impuesto</option>
                              <option value="0" >No tiene impuesto</option>
                              </select>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Imagen:</label>
