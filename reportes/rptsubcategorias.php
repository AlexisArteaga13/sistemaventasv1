...
$pdf->Cell(40,6,'',0,0,'C');
$pdf->Cell(100,6,'LISTA DE SUB CATEGORIAS',1,0,'C'); 
$pdf->Ln(10);
...
{  
    $nombre = $reg->nombre_subcat;
    $descripcion = $reg->descripcion_subcat;
 	$categoria = $reg->categoria;
 	$pdf->SetFont('Arial','',10);
    $pdf->Row(array(utf8_decode($nombre),utf8_decode($descripcion),utf8_decode($categoria)));
}
